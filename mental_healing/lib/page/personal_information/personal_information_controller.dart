...
//   RxInt selectedAge = (GlobalDataManager().userInfo.value.age ?? 20).obs;
...
//   final user = GlobalDataManager().userInfo.value;
...
//     String updateUrl =
//         '${Config.apiUrl}/users/${GlobalDataManager().userInfo.value?.id}/update';
