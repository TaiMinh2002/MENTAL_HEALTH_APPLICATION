...
class SelectSleep extends StatefulWidget with BaseMixin {
  SelectSleep({super.key, required this.onChange});
...
class _SelectSleepState extends State<SelectSleep> {
  ...
  void _setSleepValue(int value) {
    ...
    switch (value) {
      case 1:
        widget.onChange(Sleep.sevenToNineHours);
        break;
      case 2:
        widget.onChange(Sleep.sixToSevenHours);
        break;
      case 3:
        widget.onChange(Sleep.fiveHours);
        break;
      case 4:
        widget.onChange(Sleep.threeToFourHours);
        break;
      case 5:
        widget.onChange(Sleep.lessThan3Hours);
        break;
      default:
        widget.onChange(Sleep.sevenToNineHours);
    }
