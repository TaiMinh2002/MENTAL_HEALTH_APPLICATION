...
mixin _$PostInfo {
  ...
  String? get post_created_at => throw _privateConstructorUsedError;
...
class _$PostInfoCopyWithImpl<$Res, $Val extends PostInfo>
  ...
  $Res call({
    ...
    Object? post_created_at = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      title: freezed == title
          ...
          : title // ignore: cast_nullable_to_non_nullable
              as String?,
      post_created_at: freezed == post_created_at
          ? _value.post_created_at
          : post_created_at // ignore: cast_nullable_to_non_nullable
              as String?,
    ) as $Val);
  }
}
...
class _$PostInfoImpl implements _PostInfo {
  ...
  @override
  String toString() {
    return 'PostInfo(id: $id, forum_id: $forum_id, user_id: $user_id, username: $username, like_count: $like_count, comment_count: $comment_count, content: $content, title: $title, post_created_at: $post_created_at)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.post_created_at, post_created_at) ||
                other.post_created_at == post_created_at));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, forum_id, user_id, username,
      like_count, comment_count, content, title, post_created_at);
...
abstract class _PostInfo implements PostInfo {
  const factory _PostInfo(
      ...
      final String? content,
      final String? title,
      final String? post_created_at}) = _$PostInfoImpl;
