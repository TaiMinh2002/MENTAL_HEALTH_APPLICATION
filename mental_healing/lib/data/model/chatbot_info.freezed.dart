...
abstract class $ChatbotInfoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? user_message, String? bot_reply, String? created_at});
}
...
class _$ChatbotInfoImpl implements _ChatbotInfo {
  const _$ChatbotInfoImpl({this.user_message, this.bot_reply, this.created_at});
  ...
  @override
  String toString() {
    return 'ChatbotInfo(user_message: $user_message, bot_reply: $bot_reply, created_at: $created_at)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, user_message, bot_reply, created_at);
...
abstract class _ChatbotInfo implements ChatbotInfo {
  const factory _ChatbotInfo(
      {final String? user_message,
      final String? bot_reply,
      final String? created_at}) = _$ChatbotInfoImpl;
