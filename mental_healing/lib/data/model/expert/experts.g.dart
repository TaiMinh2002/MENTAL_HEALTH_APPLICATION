...
_$ExpertsImpl _$$ExpertsImplFromJson(Map<String, dynamic> json) =>
    _$ExpertsImpl(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => ExpertInfo.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$$ExpertsImplToJson(_$ExpertsImpl instance) =>
    <String, dynamic>{
      'data': instance.data,
