...
_$ChatExpertsImpl _$$ChatExpertsImplFromJson(Map<String, dynamic> json) =>
    _$ChatExpertsImpl(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => RoomChatResult.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$$ChatExpertsImplToJson(_$ChatExpertsImpl instance) =>
    <String, dynamic>{
      'data': instance.data,
