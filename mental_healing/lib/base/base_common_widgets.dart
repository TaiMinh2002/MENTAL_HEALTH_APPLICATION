...
mixin BaseCommonWidgets {
                      ...
                      children: [
                        Text(
                          ...
                          style: AppTextStyle.share
                              .semiBold(size: 16, color: appThemes.blackColor),
                        ...
                        Visibility(
                            ...
                            child: Text(
                              ...
                              style: AppTextStyle.share.semiBold(
                                  size: 16, color: appThemes.blackColor),
                              textAlign: TextAlign.center,
                            ))
                      ],
                    ),
  ...
  void showCustomGeneralDialog({
    ...
    showGeneralDialog(
        barrierColor: appThemes.blackColor.withOpacity(0.6),
          ...
          return Center(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: backgroundColor ?? appThemes.whiteColor,
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: AppTextStyle.share.bold(
                            size: 30,
                            color: titleColor ?? appThemes.blackColor),
                        textAlign: TextAlign.center,
                      ),
                    ),
                  if (message != null)
                      ...
                      children: [
                        ...
                        Expanded(
                          child: WidgetButton(
                            ...
                            textColor:
                                confirmTitleColor ?? appThemes.whiteColor,
                            backgroundColor:
